...
return [
    ...
    */
    ...
    'project_logo'   => env('ADMIN_TITLE', 'cms<b>Snack</b>'),

    // Show / hide breadcrumbs on admin panel pages.
    'breadcrumbs' => true,

    // Horizontal navbar classes. Helps make the admin panel look similar to your project's design.
    'header_class' => 'app-header bg-dark bg-blue-xp border-0 navbar',
    ...
    'footer_class' => 'app-footer d-print-none sticky-footer',
    // hide it with d-none
    ...
    */
    ...
    'authentication_column'      => env('BACKPACK_AUTHENTICATION_COLUMN', 'mobile'),
    'authentication_column_name' => env('BACKPACK_AUTHENTICATION_COLUMN_NAME', 'شماره همراه'),
