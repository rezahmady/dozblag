...
class AddAdminMenuItem extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'modules:backpack:add-admin-menu {module}
    ...
    {
        $path = "Modules/".$this->argument('module')."/Providers/HookServiceProvider.php";
        ...
        if ($disk->exists($path)) {
            ...
            $file_lines[$end_line_number + 4] = $file_lines[$end_line_number + 3];
            $file_lines[$end_line_number + 3] = $file_lines[$end_line_number + 2];
            $file_lines[$end_line_number + 2] = $file_lines[$end_line_number + 1];
    ...
    private function customRoutesFileEndLine($file_lines)
    {
        ...
        $end_line_number = array_search('            // this should be the absolute last line of admin menu', $file_lines);
