...
namespace Modules\Subscribtion\Http\Controllers\Admin;

use Modules\Subscribtion\Http\Requests\SubscribtionRequest;
...
class SubscribtionCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\Modules\Subscribtion\Models\Subscribtion::class);
