...
use Modules\Payment\Http\Requests\TransactionRequest;
...
class TransactionCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\Modules\Payment\Models\Transaction::class);
    ...
    protected function setupListOperation()
    {
        ...
        $this->crud->addFilter([
            ...
            'zarinpal' => trans("payment::payment.drivers.zarinpal"),
            'idpay' => trans("payment::payment.drivers.idpay"),
            'behpardakht' => trans("payment::payment.drivers.behpardakht"),
            'saman' => trans("payment::payment.drivers.saman"),
          ], function($value) {
