...
use Modules\User\Http\Requests\RoleStoreCrudRequest as StoreRequest;
use Modules\User\Http\Requests\RoleUpdateCrudRequest as UpdateRequest;
...
class RoleCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setModel($this->role_model);
        $this->crud->setEntityNameStrings(trans('user::permissionmanager.role'), trans('user::permissionmanager.roles'));
    ...
    public function setupListOperation()
    {
        ...
        $this->crud->addColumn([
            'label'     => trans('user::permissionmanager.users'),
            'type'      => 'text',
            'name'      => 'users_count',
            'wrapper'   => [
