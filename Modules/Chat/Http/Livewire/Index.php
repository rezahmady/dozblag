...
use Modules\Chat\Models\Room as RoomModel;
use Modules\Chat\Http\Livewire\Traits\WithAudience;
use Modules\Chat\Events\MessageSeen;
use Modules\Chat\Events\MessageSeenResponse;
use Modules\Chat\Events\RoomEnded;
...
class Index extends Component
{
    ...
    {
        return view('chat::skin.index')->layout('chat::skin.layouts.app');
    }
}
