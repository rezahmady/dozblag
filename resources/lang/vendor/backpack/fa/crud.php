...
return [
    ...
    */
    ...
    'save_action_save_and_preview'     => 'دخیره و مشاهده',
    ...
    'reset' => 'تازه سازی صفحه',

    'clone' => 'کپی',
    'clone_success'             => '<strong>مورد کپی شد</strong><br>یک ورودی جدید اضافه شده است، با همان اطلاعات مورد انتخاب شده.',
    'clone_failure'             => '<strong>کپی انجام نشد</strong><br>مورد جدید ایجاد نشد. لطفا دوباره تلاش کنید.',
