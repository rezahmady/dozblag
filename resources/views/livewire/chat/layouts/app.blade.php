    ...
    <div class="content">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <figure class="avatar avatar-state-success">
                                <img src="/packages/chatino/media/img/man_avatar1.jpg" class="rounded-circle">
                            </figure>
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="users-list-body">
                                <h5>گروه سرگرمی</h5>
                                <p><strong>مجتبی شاهی: </strong>سلااام!!!</p>
                                <div class="users-list-action action-toggle">
                                    <div class="dropdown">
                                        <a data-toggle="dropdown" href="#">
                                            <i class="ti-more"></i>
                ...
                <div class="sidebar-body">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <div>
                                <figure class="avatar">
                                    <img src="/packages/chatino/media/img/man_avatar5.jpg" class="rounded-circle">
                                </figure>
                            </div>
                            <div class="users-list-body">
                                <h5>مایکل صیدرا</h5>
        ...
        <div class="chat">
                ...
                <div class="messages">
                    <div class="message-item outgoing-message">
                        <div class="message-content">
                            سلام ، ماهر! منتظر هستم که پرونده ها را برای من ارسال کنید.
                        </div>
                        <div class="message-action">
                            بعد ظهر 4:30 <i class="ti-double-check"></i>
                        </div>
                    </div>
                    <div class="message-item">
                        <div class="message-content">
                             متاسفم :( من هرچه سریعتر برای شما ارسال خواهم کرد.
                        </div>
                        <div class="message-action">
                            بعد ظهر 4:30 
                        </div>
                    ...
                    <div class="message-item">
                        <div class="message-content message-file">
                            ...
                            <div>
                                ...
                                <ul class="list-inline">
                                    <li class="list-inline-item"><a href="#">دانلود</a></li>
                    ...
                    <div class="message-item outgoing-message">
                        <div class="message-content">
                            خیلی ممنونم. پس از بررسی این پرونده ها ، نظر خود را برای شما بیان می کنم. اگر مشکلی پیش آمد ، می توانید دوباره آن را ارسال کنید. موفق باشید!
                        </div>
                        <div class="message-action">
                            بعد ظهر 4:30  <i title="پیام ارسال نشد" class="ti-info-alt text-danger"></i>
                        </div>
                    </div>
                    <div class="message-item">
                        <div class="message-content">
                    ...
                    <div class="message-item outgoing-message">
                        <div class="message-content">
                            می دانم این پرونده برای شما چقدر مهم است. تو میتوانی به من اعتماد کنی ؛)
                        </div>
                        <div class="message-action">
                            بعد ظهر 4:30  <i class="ti-double-check"></i>
                        </div>
            ...
            <div class="chat-footer">
                <form action="#">
                    <input type="text" class="form-control" placeholder="نام کاربری گیرنده"
                           aria-label="نام کاربری گیرنده" aria-describedby="button-addon2">
...
<!-- JQuery -->
<script src="/packages/chatino/js/vendor/jquery-3.4.1.min.js"></script>

<!-- Popper.js -->
<script src="/packages/chatino/js/vendor/popper.min.js"></script>

<!-- Bootstrap -->
<script src="/packages/chatino/js/vendor/bootstrap/bootstrap.min.js"></script>

<!-- Nicescroll -->
<script src="/packages/chatino/js/vendor/jquery.nicescroll.min.js"></script>

<!-- Soho -->
<script src="/packages/chatino/js/soho.min.js"></script>
