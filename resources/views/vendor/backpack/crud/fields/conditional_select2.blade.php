...
@include('crud::fields.inc.wrapper_start')
    ...
    <input
        type="hidden"
        name="{{ $field['name'] }}"
        data-init-function="bpFieldInitConditionalSelect2Element"
        value="{{ $field['value'] }}"
    ...
    <div class="container-conditional-elements">
        ...
        <div class="col-md-12 well m-0 p-0 row" data-conditional-identifier="{{ $field['name'] }}" data-conditional-value="{{ $key }}">
...
@if ($crud->fieldTypeNotLoaded($field))
  ...
  @push('crud_fields_scripts')
      <script>
         ...
         */
        function bpFieldInitConditionalSelect2Element(element) {
            // handel radio input
            var hiddenInput = $("select[name={{ $field['select_field'] }}]");
