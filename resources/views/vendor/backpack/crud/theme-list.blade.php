...
@section('content')
  ...
  <div class="row">
    ...
    <div class="{{ $crud->getListContentClass() }}">
        ...
        <div class="row" >
            <div class="col-sm-4">
                <img class="img-responsive" width="300px" src="{{ url(config('themes.assets_folder')) }}/{{ $theme->folder }}/{{ $theme->folder }}.jpg">
            </div>
            <div class="col-sm-8">
                <h3 class="margin-top">
                    {{ $theme->name }}
        ...
        <div class="row">            
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="brand-card">
                  <div class="brand-card-header" style="height:200px;background-size: cover;background-image: url('{{ url(config('themes.assets_folder')) }}/{{ $entry->folder }}/{{ $entry->folder }}.jpg')"></div>
