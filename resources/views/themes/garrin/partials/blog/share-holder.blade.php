<ul class="social-share {{$class}}">
    ...
    <li><a wire:click="telegram()" href="https://t.me/share/url?url={{ $post->path() }}&text={{ rawurlencode($post->title) }}" title="اشتراک گزاری در تلگرام"><i class="fab fa-telegram"></i><span class="social-value">
    {{$telegram}}  
    </span></a></li>
</ul>