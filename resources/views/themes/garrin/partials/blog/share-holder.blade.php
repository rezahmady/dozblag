<ul class="social-share {{$class}}">
    ...
    <li><a wire:click="telegram()" href="https://t.me/iv?url={{ urlencode($post->path()) }}&rhash=a702ddb0e6dcd" title="اشتراک گزاری در تلگرام"><i class="fab fa-telegram"></i><span class="social-value">
    {{$telegram}}  
    </span></a></li>
