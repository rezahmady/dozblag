...
namespace Rezahmady\Filter\Http\Controllers\Admin;

use Rezahmady\Filter\Http\Requests\FilterItemRequest;
 ...
 */
class FilterItemCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/filteritem');
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::addColumn([
         ...
         $this->crud->addFilter([ // select2 filter
            ...
            return \Rezahmady\Filter\Models\Filter::all()->keyBy('id')->pluck('name', 'id')->toArray();
    ...
    protected function setupCreateOperation()
    {
        ...
        // CRUD::field('filter_id')->label('دسته');
        ...
        $this->crud->addField([
            ...
            'prefix'    => 'uploads/images/filter/', // in case your db value is only the file name (no path), you can use this to prepend your path to the image src (in HTML), before it's shown to the user;
            'wrapper'      => [
    ...
    {
        return $this->fetch(Filter::class);
    }
