...
use Rezahmady\Filter\Http\Requests\FilterRequest;
 ...
 */
class UserFilterCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/resource/filter');
        ...
        CRUD::addColumn([   // select_multiple: n-n relationship (with pivot table)
            ...
            'wrapper'   => [
                'href' => function ($crud, $column, $entry, $related_key) {
                    return backpack_url('/resource/filteritem?filter_id='.$entry->getKey());
                },
            ],
        ]);
