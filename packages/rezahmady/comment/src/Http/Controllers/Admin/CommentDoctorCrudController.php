...
namespace Rezahmady\Comment\Http\Controllers\Admin;

use Rezahmady\Comment\Http\Requests\CommentRequest;
 ...
 */
class CommentDoctorCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\Rezahmady\Comment\Models\Comment::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/user/doctor/comment');
        CRUD::setEntityNameStrings('کامنت', 'کامنت ها');
    ...
    */
    protected function setupUpdateOperation()
    {
        ...
        CRUD::addFields([
            ...
            [
                'name'  => 'score',
                'value' => $this->crud->getCurrentEntry()->score,
                'type'  => 'hidden',
            ],
            [
                'name'  => 'user_id',
