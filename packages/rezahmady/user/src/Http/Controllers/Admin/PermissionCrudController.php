...
use Rezahmady\User\Http\Requests\PermissionStoreCrudRequest as StoreRequest;
use Rezahmady\User\Http\Requests\PermissionUpdateCrudRequest as UpdateRequest;
