...
namespace Rezahmady\Product\Http\Controllers\Admin;

use Rezahmady\Product\Http\Requests\ProductRequest;
use Rezahmady\Product\Models\Filter;
use App\Traits\DefaultPermissions;
use Rezahmady\Product\Traits\ProductTemplates;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;
use Rezahmady\Product\Models\Product;
...
class ProductCrudController extends CrudController
{
    ...
    public function getTemplates($template_name = false)
    {
        ...
        $templates_trait = new \ReflectionClass(ProductTemplates::class);
